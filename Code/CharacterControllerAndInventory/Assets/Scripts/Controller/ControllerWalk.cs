...
public class ControllerWalk : AbstractController, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    private void Start()
    {
        ...
        joystick.sprite = joystickSprite;
        joystickBG.sprite = joystickBGSprite;
    }
